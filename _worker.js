...
<style>
:root{color-scheme:light; font-family:system-ui,-apple-system,"Segoe UI",sans-serif}*{box-sizing:border-box}body{margin:0;background:#f4f6f8;color:#17202a}main{max-width:1600px;margin:32px auto;padding:0 20px}h1{font-size:26px;margin:0 0 22px}.panel{background:#fff;border:1px solid #dfe4ea;border-radius:8px;padding:20px;margin-bottom:18px;box-shadow:0 2px 8px #17202a0d}.row{display:flex;gap:12px;align-items:end;flex-wrap:wrap}.field{display:flex;flex-direction:column;gap:6px;min-width:180px}label{font-size:13px;color:#52606d}input{height:36px;border:1px solid #c8d0d9;border-radius:5px;padding:0 10px;font-size:14px}button{height:36px;border:0;border-radius:5px;background:#1769e0;color:#fff;padding:0 14px;cursor:pointer;white-space:nowrap}button.secondary{background:#e9eef5;color:#1f2933}button.danger{background:#c53030}button:disabled{opacity:.6;cursor:wait}.hint{color:#697586;font-size:13px;margin-top:10px}#message{min-height:22px;margin:8px 0;color:#1769e0}.table-wrap{overflow-x:auto;overflow-y:hidden}table{width:100%;border-collapse:collapse;min-width:1360px}th,td{border-bottom:1px solid #edf0f3;text-align:left;padding:11px 8px;font-size:13px;vertical-align:middle;white-space:nowrap}th{color:#52606d;background:#f8fafc;font-weight:600}code{word-break:normal;white-space:nowrap;color:#364152}.status-active{color:#087443}.status-expired,.status-disabled{color:#c53030}.actions{display:flex;gap:6px;align-items:center;white-space:nowrap}.actions input{width:110px}.small{font-size:12px;color:#697586}.empty{text-align:center;color:#697586;padding:24px}
</style>
</head>
<body><main>
<h1>订阅 Token 管理</h1>
